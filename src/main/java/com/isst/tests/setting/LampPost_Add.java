...
public class LampPost_Add extends MySuite {
...
//		dc.insertdatatable(lamp);
	...
	public void testAddCity() throws Exception {
		...
		ig.inPage();
		ig.clickAdd();
		ig.fillNode("testAddLampPost", "testAddLampPostN", "100.012345", "30.065432",null);
		ig.selectStreet("testEditArchCenter", "roadTestModify");
		ig.confirm();

		lg.assertEquals("操作结果 : ",lg.getRespMessage(), "操作成功");

		Map<String,Object> m = jdbcTemplate.queryForMap("select * from sm_lamppost t where t.lamppost_num_='testAddLampPostN';");
		...
		lg.assertEquals("lamppost_num_ :", m.get("lamppost_num_").toString(),"testAddLampPostN");
		...
		lg.assertEquals("name_ :", m.get("name_").toString(),"testAddLampPost");
