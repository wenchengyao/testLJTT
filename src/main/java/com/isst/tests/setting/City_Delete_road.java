...
public class City_Delete_road extends MySuite {
	...
	public void testDeleteCountry() throws Exception {
		...
		ig.inPage();
		ig.clickDel("街道", "roadTestDelete");

		lg.assertEquals("操作结果 : ",lg.getRespMessage(), "操作成功");

		Map<String,Object> m = jdbcTemplate.queryForMap("select count(1) as num from sm_architecture t where t.number_='ADroadTestDelete';");
