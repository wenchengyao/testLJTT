...
public class City_Add_city extends MySuite {
	...
	public void testAddCity() throws Exception {
		...
		ig.inPage();
		ig.clickAdd("国家", "countryTestCity");
		ig.fillNode("testAddArchCity", "CityNum", "100.012345", "30.065432",null);
		ig.confirm();

		lg.assertEquals("操作结果 : ",lg.getRespMessage(), "操作成功");

		Map<String,Object> m = jdbcTemplate.queryForMap("select * from sm_architecture t where t.number_='ADCityNum';");
		...
		lg.assertEquals("name_ :", m.get("name_").toString(),"testAddArchCity");
		lg.assertEquals("number_ :", m.get("number_").toString(),"ADCityNum");
